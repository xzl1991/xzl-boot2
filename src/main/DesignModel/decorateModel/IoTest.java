...
public class IoTest {
    public static void main(String[] args) {
        String fileName = "D:/logs/test.txt";
        try {
            //读取文件
            InputStream inputStream = new FileInputStream(fileName);

            //InputStream相当于被装饰的接口或者抽象类，FileInputStream相当于原始的待装饰的对象，FileInputStream无法               装饰InputStream
            ...
            int length = inputStream.available();//记录长度
            System.out.println("FileInputStream不支持mark和reset：" + inputStream.markSupported());

             /* 下面分别展示三种装饰器的作用BufferedInputStream,DataInputStream,PushbackInputStream,LZ下面做了三个                  装饰器的功能演示
             * */
            ...
            bufferedInputStream.mark(0);//标记
            char c = (char)bufferedInputStream.read();
            System.out.println("文件的第一个字符是:"+c);
            bufferedInputStream.reset();//重置
            c = (char)bufferedInputStream.read();//继续读
            ...
            PushbackInputStream pushbackInputStream = new PushbackInputStream(inputStream,length);//装饰成 PushbackInputStream
            ...
            pushbackInputStream.unread(bytes);//回退回去

            bytes = new byte[length];//清空byte数组
            pushbackInputStream.read(bytes);//再度
            ...
            System.out.println("---------------------------------------------------------------------------------");
            BufferedReader bufferedReader = new BufferedReader(inputStreamReader);//进一步在reader的基础上装饰成BufferedReader
            System.out.println("BufferedReader有readLine等功能：" + bufferedReader.readLine());
            System.out.println("---------------------------------------------------------------------------------");
            LineNumberReader lineNumberReader = new LineNumberReader(inputStreamReader);//进一步在reader的基础上装饰成LineNumberReader
            ...
            PushbackReader pushbackReader = new PushbackReader(inputStreamReader,length);//进一步在reader的基础上装饰成PushbackReader
            ...
            chars = new char[length];//清空char数组
